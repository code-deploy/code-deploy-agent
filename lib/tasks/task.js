...
var _mixin_timeout = require('./mixin_timeout');
...
var Task = exports.Task = (0, _mixin_meta.mixMeta)(_class = (0, _mixin_source.mixSource)(_class = (0, _mixin_status.mixStatus)(_class = (0, _mixin_timeout.mixTimeout)(_class = function (_TaskBase) {
  ...
  _createClass(Task, [{
    ...
    value: function start() {
      ...
      Promise.all([this.source.read(), // 下载源文件
      this.execute() // 执行部署脚本
  ...
  return Task;
}(_base.TaskBase)) || _class) || _class) || _class) || _class;
